...
COLUMN_MAP: dict[str, list[str]] = {
    ...
    "area_sqm":      ["Property Sold Area", "Sold Area (sqm)", "Sold Area",
                      "Built-up Area (sqm)"],
    "land_area_sqm": ["Land Plot Ground Area", "Plot Area (sqm)", "Plot Area",
                      "Land Area (sqm)"],
    "price_aed":     ["Property Sale Price", "Sale Price", "Price (AED)", "Price"],
    "sold_share":    ["Property Sold Share", "Sold Share", "Share"],
    "rate_aed_sqm":  ["Rate ( ب /sqm )", "Rate (AED/sqm)", "Rate ( Ð /sqm )",
                      "Rate (D /sqm)", "Rate"],
    "sale_type":     ["Sale Type"],
