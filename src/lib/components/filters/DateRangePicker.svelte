  ...
  {#if showCustom || $filters.dateRange === 'custom'}
    <div class="flex items-center gap-2 ml-2">
      <input
        ...
        class="rounded-lg border border-gray-200 bg-white px-2.5 py-1 text-xs text-gray-700 focus:border-brand-400 focus:outline-none focus:ring-2 focus:ring-brand-100"
      />
