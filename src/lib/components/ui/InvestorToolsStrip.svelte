...
<div class="mt-10 rounded-2xl border {t.border} bg-gradient-to-br {t.bg} px-5 py-5">
  <div class="flex items-center gap-2 mb-4">
    <span class="inline-flex items-center justify-center w-6 h-6 rounded-full {t.badge} text-white">
  ...
  <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
    ...
    <a
      ...
      class="group relative flex flex-col gap-1.5 rounded-xl border {t.cardBorder} bg-white hover:shadow-md hover:bg-gray-50 px-4 py-3.5 transition-all cursor-pointer"
    >
      <div class="flex items-center gap-2">
        ...
        <svg class="w-3.5 h-3.5 text-gray-300 group-hover:{t.iconColor} transition-colors flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5">
