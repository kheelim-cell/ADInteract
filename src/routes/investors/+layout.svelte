<script lang="ts">
  ...
  const NAV_ITEMS = [
    ...
    },
    {
      ...
      label: m.investors_nav_developers_label(),
      short: m.investors_nav_developers_short(),
      description: m.investors_nav_developers_desc(),
      iconPath: 'M18 18.72a9.094 9.094 0 0 0 3.741-.479 3 3 0 0 0-4.682-2.72m.94 3.198.001.031c0 .225-.012.447-.037.666A11.944 11.944 0 0 1 12 21c-2.17 0-4.207-.576-5.963-1.584A6.062 6.062 0 0 1 6 18.719m12 0a5.971 5.971 0 0 0-.941-3.197m0 0A5.995 5.995 0 0 0 12 12.75a5.995 5.995 0 0 0-5.058 2.772m0 0a3 3 0 0 0-4.681 2.72 8.986 8.986 0 0 0 3.74.477m.94-3.197a5.971 5.971 0 0 0-.94 3.197M15 6.75a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm6 3a2.25 2.25 0 1 1-4.5 0 2.25 2.25 0 0 1 4.5 0Zm-13.5 0a2.25 2.25 0 1 1-4.5 0 2.25 2.25 0 0 1 4.5 0Z',
    },
    {
      href: `${base}/investors/visa`,
      label: m.investors_nav_visa_label(),
      short: m.investors_nav_visa_short(),
      description: m.investors_nav_visa_desc(),
      iconPath: 'M15 9h3.75M15 12h3.75M15 15h3.75M4.5 19.5h15a2.25 2.25 0 0 0 2.25-2.25V6.75A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25v10.5A2.25 2.25 0 0 0 4.5 19.5Zm6-10.125a1.875 1.875 0 1 1-3.75 0 1.875 1.875 0 0 1 3.75 0Zm1.294 6.336a6.721 6.721 0 0 1-3.17.789 6.721 6.721 0 0 1-3.168-.789 3.376 3.376 0 0 1 6.338 0Z',
    },
    {
      href: `${base}/investors/watchlist`,
      label: m.investors_nav_watchlist_label(),
      short: m.investors_nav_watchlist_short(),
      description: m.investors_nav_watchlist_desc(),
    ...
    {
      href: `${base}/investors/profile`,
      label: m.investors_nav_profile_label(),
      short: m.investors_nav_profile_short(),
      description: m.investors_nav_profile_desc(),
