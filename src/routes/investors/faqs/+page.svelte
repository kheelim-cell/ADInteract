      ...
      <table class="w-full text-sm">
        ...
        <thead>
          <tr class="bg-gray-800 text-white">
            <th class="px-4 py-3 text-left text-xs font-bold uppercase tracking-wider w-[28%]">Fee Category</th>
            <th class="px-4 py-3 text-left text-xs font-bold uppercase tracking-wider w-[24%]">Line Item</th>
        ...
        <tbody class="divide-y divide-gray-100">
          {#each TABLE_SECTIONS as section, si}
            <!-- Category header row -->
            <tr class="bg-gray-50">
              <td colspan="4" class="px-4 py-2.5 text-xs font-bold text-gray-600 uppercase tracking-wider border-t-2 border-gray-200">
                {section.category}
              </td>
            </tr>
            ...
            {#each section.rows as row, ri}
              <tr class="{ri % 2 === 0 ? 'bg-white' : 'bg-gray-50/50'} hover:bg-emerald-50/30 transition-colors">
                ...
                <td class="px-4 py-2.5 text-xs text-gray-600 font-medium">{row.item}</td>
                <td class="px-4 py-2.5 text-xs text-gray-800">{row.abu_dhabi}</td>
                <td class="px-4 py-2.5 text-xs text-gray-500">{row.dubai}</td>
              </tr>
            {/each}
          {/each}
          ...
          <tr class="bg-emerald-50 border-t-2 border-emerald-200">
            <td class="px-4 py-3 text-xs font-bold text-gray-700 uppercase tracking-wider">Total Closing Costs</td>
            <td class="px-4 py-3 text-xs text-gray-500">excl. down payment</td>
            <td class="px-4 py-3 text-sm font-bold text-emerald-700">~4–7% of purchase price</td>
            <td class="px-4 py-3 text-sm font-semibold text-gray-600">~7–9% of purchase price</td>
          </tr>

          <!-- Net delta row -->
          <tr class="bg-emerald-100/60">
            <td class="px-4 py-3 text-xs font-bold text-gray-700 uppercase tracking-wider">Net Delta</td>
            <td class="px-4 py-3"></td>
            <td colspan="2" class="px-4 py-3 text-sm font-bold text-emerald-700">
