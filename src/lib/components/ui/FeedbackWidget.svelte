...
{#if !isOpen}
  <button
    ...
    class="fixed bottom-6 end-6 z-50 flex items-center gap-2 rounded-full bg-[#0a2318] text-white text-sm font-semibold px-4 py-3 shadow-lg hover:bg-[#143524] transition-all duration-200 hover:scale-105 active:scale-95"
  >
...
{#if isOpen}
  ...
  <!-- Panel -->
  <div
    class="fixed bottom-6 end-6 z-50 w-[340px] rounded-2xl bg-white shadow-2xl border border-gray-100 overflow-hidden"
    role="dialog"
    aria-modal="true"
